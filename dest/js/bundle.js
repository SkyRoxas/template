...
var _member_popup = __webpack_require__(10);
...
var _popups = __webpack_require__(11);
...
var memberPopup = function memberPopup() {
  ...
  var from = function from() {
    return (0, _jquery2.default)('.form_application').html();
  };

  var popup = function popup(str) {
    _popups2.default.modal({
      content: str
    });
  };
  (0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.member-page .btn-popup').click(function () {
      popup(from());
    });
  });
};

exports.default = memberPopup;
...
var ResponsiveMenu = function ResponsiveMenu() {
  (0, _jQuery2.default)(function () {
    var mobile_header = (0, _jQuery2.default)('#mobile_header');
    var menu_open_button = (0, _jQuery2.default)('#toggle', mobile_header);
    var menu_close_button = (0, _jQuery2.default)('#close', mobile_header);
    var menu = (0, _jQuery2.default)('.mobile_menu', mobile_header);
    var search_form = (0, _jQuery2.default)('#search_form');
    var search_form_close = (0, _jQuery2.default)('.search_close', search_form);
    var search_form_open = (0, _jQuery2.default)('#search', mobile_header);

    menu_open_button.click(function (e) {
      menu.addClass('active');
    });

    menu_close_button.click(function (e) {
      menu.removeClass('active');
    });

    search_form_open.click(function (e) {
      search_form.fadeIn();
      e.preventDefault();
    });

    search_form_close.click(function (e) {
      search_form.fadeOut();
      e.preventDefault();
    });
  });
